...
#line hidden
        ...
        [Xunit.FactAttribute(DisplayName="Taking no damage when hit doesnt affect health")]
        [Xunit.TraitAttribute("FeatureTitle", "PlayerCharacter")]
        [Xunit.TraitAttribute("Description", "Taking no damage when hit doesnt affect health")]
        public virtual void TakingNoDamageWhenHitDoesntAffectHealth()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Taking no damage when hit doesnt affect health", ((string[])(null)));
#line 19
this.ScenarioSetup(scenarioInfo);
#line 6
this.FeatureBackground();
...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Elf race character get additional 20 damage resistance", new string[] {
                        "elf"});
#line 33
this.ScenarioSetup(scenarioInfo);
#line 6
...
#line hidden
        ...
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Elf race character get additional 20 damage resistance using data table", new string[] {
                        "elf"});
#line 40
this.ScenarioSetup(scenarioInfo);
#line 6
