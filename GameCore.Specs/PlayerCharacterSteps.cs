...
namespace GameCore.Specs
{
    ...
    public class PlayerCharacterSteps
    {
        ...
        public void ThenMyHealthShouldNowBe(int expected)
        {
            Assert.Equal(expected, _context.Player.Health);
        }
        ...
        public void GivenIHaveAnAmuletWithPowerOf(int power)
        {
